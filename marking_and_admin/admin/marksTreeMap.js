document.addEventListener("DOMContentLoaded", function() {
  ...
  const rows = [
    ...
    [
      ...
      null,
      null,
      "There won't be a lecture this week",
      "http://awebsite.com",
      week(6, "Monday"),
      week(7, "Sunday"),
      "Semester period",
    ...
    [
      ...
      null,
      null,
      "This is just a time period, admittedly an important one!",
      "http://awebsite.com",
      week(1, "Monday"),
      week(16, "Friday"),
      "Semester period",
    ...
    [
      ...
      25,
      null,
      "A record of your work and thinking",
      "http://awebsite.com",
      week(1, "Friday"),
      week(15, "Wednesday"),
      "nice name",
    ...
    [
      ...
      15,
      null,
      "A real life programming task with machine learning",
      "http://awebsite.com",
      week(7, "Tuesday"),
      week(9, "Friday"),
      "nice name",
    ...
    [
      ...
      (15 / 100) * 33,
      null,
      "How readable it is? Comments. Linting.",
      "http://awebsite.com",
      week(7, "Tuesday"),
      week(9, "Friday"),
      "nice name",
    ...
    [
      ...
      (15 / 100) * 33,
      null,
      "What is the size and the scope of the challenges?",
      "http://awebsite.com",
      week(7, "Tuesday"),
      week(9, "Friday"),
      "nice name",
    ...
    [
      ...
      (15 / 100) * 34,
      null,
      "How well does it work as a useable product?",
      "http://awebsite.com",
      week(7, "Tuesday"),
      week(9, "Friday"),
      "nice name",
    ...
    [
      ...
      10,
      null,
      "Programming questions, under pressure",
      "http://awebsite.com",
      week(7, "Tuesday"),
      week(8, "Tuesday", 13),
      "nice name",
    ...
    [
      ...
      (35 / 100) * 30,
      null,
      "How good is your code from a technical POV?",
      "http://awebsite.com",
      week(9, "Tuesday"),
      week(14, "Tuesday"),
      "nice name",
    ...
    [
      ...
      (35 / 100) * 13,
      null,
      "Make the data usable, repeatably and well documented",
      "http://awebsite.com",
      week(9, "Tuesday"),
      week(14, "Tuesday"),
      "nice name",
    ...
    [
      ...
      (35 / 100) * 20,
      null,
      "Does what you've made aid understanding of the world?",
      "http://awebsite.com",
      week(9, "Tuesday"),
      week(14, "Tuesday"),
      "nice name",
    ...
    [
      ...
      (35 / 100) * 17,
      null,
      "Present your tool and findings",
      "http://awebsite.com",
      week(14, "Tuesday"),
      week(14, "Tuesday", 13),
      "nice name",
    ...
    [
      ...
      15,
      null,
      "Problems to check that you are understanding things",
      "http://awebsite.com",
      week(1, "Tuesday"),
      week(7, "Friday"),
      "nice name",
    ...
    [
      ...
      15 / 6,
      null,
      "More loops, a game, and a game that plays itself",
      "http://awebsite.com",
      week(3, "Tuesday"),
      week(4, "Monday", 19),
      "nice name",
    ...
    [
      ...
      15 / 6,
      null,
      "Reading and writing files, and the internet",
      "http://awebsite.com",
      week(4, "Tuesday"),
      week(5, "Monday", 19),
      "nice name",
  ...
  function drawTreeMap() {
    ...
    function showFullTooltip(row, size, value) {
      var tooltip = `<div style="background:#fd9; padding:10px; border-style:solid">
                        <h1><a href="${data.getValue(
                          row,
                          4
                        )}" target="_blank">${data.getValue(row, 0)}</a></h1>
                        <p>${Math.round(
                          data.getValue(row, 2)
                        )}% of total mark</p>
                        <p>${data.getColumnLabel(6)}: ${niceDate(
        data.getValue(row, 6)
      )}</p>
  ...
  function drawGanttChart() {
    ...
    var chart = new google.visualization.Gantt(
      document.getElementById("gantt_chart_div")
    );
